export const projects = [
  {
    ...
    gallery: [
      { src: '/images/projects/3b1a9566-5af2-4ffd-81af-23e305f38b9b_rw_3840.png', alt: 'Runway Footwear — Brand Identity', span: 2 },
      { src: '/images/projects/01bd9434-1a14-4159-b42b-3b283061a941_rw_1920.png', alt: 'Runway Footwear — Packaging' },
      { src: '/images/projects/5de62a76-326d-4017-9677-fa1e0db26407_rw_1920.png', alt: 'Runway Footwear — Social Media' },
      { src: '/images/projects/640907ac-651b-4fa2-9b5c-a11c38f43cbd_rw_600.png', alt: 'Runway Footwear — Application', span: 2 },
    ],
    next: 'odd-brewing-co',
  },
  {
    ...
    gallery: [
      { src: '/images/projects/ea7461df-90bc-478c-93c7-f54b15622a50_rw_1920.jpg', alt: 'Odd Brewing — Brand System', span: 2 },
      { src: '/images/projects/650d4116-56e9-4741-aed6-9757002bba1e_rw_1920.jpg', alt: 'Odd Brewing — Logo Mark' },
      { src: '/images/projects/2be8f34a-dcfc-4e51-9e49-58c25ed8a61d_rw_3840.jpg', alt: 'Odd Brewing — Tap Room Mark' },
      { src: '/images/projects/8dc98c08-f726-4a7c-8c84-59cd976bf7ed_rw_3840.jpg', alt: 'Odd Brewing — Packaging', span: 2 },
      { src: '/images/projects/345a6986-31b9-4763-9def-805f905836e9_rw_1920.jpg', alt: 'Odd Brewing — Can Design' },
      { src: '/images/projects/4a41c1b8-b3d7-4123-9789-4280c17dd168_rw_1920.jpg', alt: 'Odd Brewing — Full Lineup' },
      { src: '/images/projects/c136fe0b-97ac-430c-947b-0a7455154ca6_rw_1920.jpg', alt: 'Odd Brewing — Detail' },
      { src: '/images/projects/1af932ad-2ef0-4c48-8414-c00b8d4b8d31_rw_1920.jpg', alt: 'Odd Brewing — Mockup' },
      { src: '/images/projects/3b88edc4-4ff4-4f73-9d74-dd400622dd75_rw_1920.jpg', alt: 'Odd Brewing — Final' },
      { src: '/images/projects/4b4dae06-0fe3-421f-934e-1c11c5728ce0_rw_3840.jpg', alt: 'Odd Brewing — Application', span: 2 },
    ],
    next: 'edify',
  },
  {
    ...
    gallery: [
      ...
      { src: '/images/projects/31f60dfd-a4cb-4ac3-b64f-83fc305cca38_rw_1920.jpg', alt: 'Edify — Cover' },
      { src: '/images/projects/a7686831-8492-412a-8cab-eab52fd5aa94_rw_3840.jpg', alt: 'Edify — Overview' },
      { src: '/images/projects/1bc6eb7c-fe13-479f-9c17-4516f81f6bcb_rw_1200.jpg', alt: 'Edify — Detail' },
      { src: '/images/projects/121b7a6c-351c-405e-991c-a6bd437971d1_rw_1920.jpg', alt: 'Edify — Spread' },
      { src: '/images/projects/36dae557-a534-4a95-8daf-8a1704402f53_rw_1920.jpg', alt: 'Edify — Layout', span: 2 },
      { src: '/images/projects/121e845c-36a3-4d6b-bd95-117ac844abc0_rw_1920.jpg', alt: 'Edify — Application', span: 2 },
      ...
      // Brand system images
      { src: '/images/projects/5a407db2-76c1-44bb-8006-5493683ba949_rw_3840.jpg', alt: 'Edify — Brand System' },
      { src: '/images/projects/c86d44c1-b69e-4fbd-9220-330a7c9b05bb_rw_3840.jpg', alt: 'Edify — Identity' },
      // Motion video (portrait) paired with image
      { type: 'video', id: 'LhIW_AvI8F4', alt: 'Edify — Motion Design', aspect: '9/16', side: true, flex: 21 },
      { src: '/images/projects/c536382e-4026-4302-b4ff-0f4361e9b9aa_rw_1920.jpg', alt: 'Edify — Print Application', side: true, flex: 29 },
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: '/images/projects/f794d8a5-fc5c-4ba4-8bbb-81660117b533_rw_1200.jpg', alt: 'APEGA — Campaign Overview', span: 2 },
      { src: '/images/projects/daf07c4c-6ccf-4cc3-a6ef-bf9686bea16f_rw_1200.jpg', alt: 'APEGA — Infographic Poster', span: 2 },
      // Iconography section
      ...
      { src: '/images/projects/a4eb79fc-2b8b-4aa0-87cb-64aa46a5800d_rw_1920.jpg', alt: 'APEGA — Custom Iconography' },
      { src: '/images/projects/26dd7b15-eddc-45d1-b8b3-abf2660fe40f_rw_1920.jpg', alt: 'APEGA — Icons Applied' },
      ...
      { src: '/images/projects/0f557fa6-37c7-4976-b55f-9d7023fbdcd3_rw_1920.jpg', alt: 'APEGA — Magazine Ad', span: 2 },
      { src: '/images/projects/76d0affd-5e91-4ac9-98c6-9d844c545f7e_rw_1920.jpg', alt: 'APEGA — Social Media Posts' },
      { src: '/images/projects/df0d07fc-3088-468b-abfc-fa390459c7bf_rw_1920.jpg', alt: 'APEGA — Campaign Applications' },
      ...
      { src: '/images/projects/ddf21305-73c0-414d-a02b-7808bc7edeb9_rw_1920.jpg', alt: 'APEGA — Women in Workplace Campaign' },
      { src: '/images/projects/98767052-6063-40cb-94d9-b2b8c09823f4_rw_1920.jpg', alt: 'APEGA — Social Media Posts, Women Campaign' },
  ...
  },
  {
    ...
    gallery: [
      { src: '/images/projects/2388ce1d-ae19-4bf4-b993-ecd99e117892_rw_3840.jpg', alt: 'Ballet Edmonton — Overview', span: 2 },
      { src: '/images/projects/8e241ead-24f7-490c-afe7-bfc763a2eec0_rw_1920.jpg', alt: 'Ballet Edmonton — Banner' },
      { src: '/images/projects/bfe173f1-2ca0-444d-b71a-13b84f825549_rw_3840.jpg', alt: 'Ballet Edmonton — Poster' },
      { src: '/images/projects/2b2c9580-ba0e-413d-8ab0-a31c6bf16cb6_rw_1920.jpg', alt: 'Ballet Edmonton — Social Media', span: 2 },
      { src: '/images/projects/ec18dc8c-36f1-43f3-b8e0-1e628c1cea25_rw_1920.jpg', alt: 'Ballet Edmonton — Program Guide' },
      { src: '/images/projects/4ea1c4c3-8e1b-4a34-93f1-82ef5faee248_rw_1920.jpg', alt: 'Ballet Edmonton — Booklet Spread' },
      { src: '/images/projects/2e522f5b-9474-463c-b20a-ada241b0b9e7_rw_1200.jpg', alt: 'Ballet Edmonton — Ticket Portal', span: 2 },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: '/images/projects/0ae0d6bb-e09d-424f-97e1-246f90126eab_rw_3840.png', alt: 'Page The Cleaners — Brand System', span: 2 },
      { src: '/images/projects/f46b19cc-4c3b-4235-8701-5340a8824696_rw_3840.png', alt: 'Page The Cleaners — Logo' },
      { src: '/images/projects/46229af3-f2b7-471f-89be-6c09728293d9_rw_3840.png', alt: 'Page The Cleaners — Stationery' },
